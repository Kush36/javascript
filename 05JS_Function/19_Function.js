...
function loginUserMessage(username = "sam"){  // Username is parameter works only when no other parameter is their in below console function
    if(!username){     
...
console.log(loginUserMessage("Kush")) // if you do not pass any string it returnn undefined 
